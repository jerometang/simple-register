...
<div id="list-activityGroup" class="content scaffold-list" role="main">
    ...
    <table>
        ...
        <tr>
            ...
            <g:sortableColumn property="name" title="${message(code: 'activityGroup.name.label', default: 'Name')}" />
